...
//
//    public ats keyBindXray = new ats("key.xray", 100);
//    public ats keyBindNoFall = new ats("key.nofall", 100);
//    public ats keyBindModulesInfo = new ats("key.ModulesInfo", 100);
//
//    @Overwrite
...
//                this.keyBindXray, this.keyBindNoFall, this.keyBindModulesInfo};
//    }
//
//    @Shadow
//    public ats[] W;
